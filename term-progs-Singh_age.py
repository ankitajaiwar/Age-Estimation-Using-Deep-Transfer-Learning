...
model.add(Conv2D(32, (3, 3), input_shape=input_shape, activation='relu', padding='same', name='conv1', kernel_initializer = o ))
model.add(Conv2D(64, (3, 3), activation= 'relu', padding='same', name='conv2'))
model.add(Dropout(0.25))

model.add(MaxPooling2D((2, 2), strides=(2, 2), name='pool1'))
model.add(Dropout(0.25))
model.add(Conv2D(128, (3, 3), activation='sigmoid', padding='same', name='conv3'))
...
#lr = [  0.0001, 0.0000001,0.000001 , 0.00001 ]
#kern = [ 'he_uniform','lecun_normal']
#optimize = ['rmsprop', 'adam', 'adadelta']
#
#for i in range(len(kern)):
#  m(kern[i])

square_error = mean_squared_error(y_test, predictions) 
